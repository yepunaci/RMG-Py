...
class TestQMCalculator(unittest.TestCase):
    ...
    def testPickle(self):
        """
        Test that a QMCalculator object can be pickled and unpickled.
        
        ...with no loss of information.
        """
        import cPickle
        mop1 = cPickle.loads(cPickle.dumps(self.mop1,-1))
        self.assertEqual(self.mop1.settings.software, mop1.settings.software)
        self.assertEqual(self.mop1.settings.method, mop1.settings.method)
        self.assertEqual(self.mop1.settings.fileStore, mop1.settings.fileStore)
